...
export function createAnalyticsHandler() {
    async function GET(request) {
        ...
        const [[totals], viewsByDay, topPages, devices, referrers, countries, campaigns,] = await Promise.all([
            db
                .select({
                views: count(),
